...
<div class="stats-grid">
  ...
  <div class="stat-card"><div class="stat-label">Total Landlords</div><div class="stat-value">{{ $stats['landlords'] ?? 0 }}</div></div>
  <div class="stat-card"><div class="stat-label">Total Properties</div><div class="stat-value">{{ $stats['apartments'] ?? 0 }}</div></div>
