...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'app.firebase_sync_enabled' => 'boolean',
            'app.firebase_sync_in_tests' => 'boolean',
            ...
            'filesystems.links.C:\Users\MSI\Housync\public\storage' => 'string',
            ...
            'rfid.com_port' => 'string',
            'rfid.baud_rate' => 'string',
            'rfid.scan_timeout' => 'integer',
            'rfid.read_delay' => 'integer',
            'rfid.commands.ping' => 'string',
            'rfid.commands.scan_request' => 'string',
            'rfid.commands.scan_stop' => 'string',
            'rfid.commands.status' => 'string',
            'rfid.responses.pong' => 'string',
            'rfid.responses.scan_active' => 'string',
            'rfid.responses.scan_completed' => 'string',
            'rfid.responses.scan_timeout' => 'string',
...
'app.aliases.Vite','app.firebase_sync_enabled','app.firebase_sync_in_tests','auth.defaults.guard','auth.defaults.passwords',
...
'filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\Users\\MSI\\Housync\\public\\storage','logging.default',
...
'queue.batching.table','queue.failed.driver','queue.failed.database','queue.failed.table','rfid.com_port',
'rfid.baud_rate','rfid.scan_timeout','rfid.read_delay','rfid.commands.ping','rfid.commands.scan_request',
'rfid.commands.scan_stop','rfid.commands.status','rfid.responses.pong','rfid.responses.scan_active','rfid.responses.scan_completed',
'rfid.responses.scan_timeout','services.postmark.token','services.resend.key','services.ses.key','services.ses.secret',
'services.ses.region','services.slack.notifications.bot_user_oauth_token','services.slack.notifications.channel','services.supabase.url','services.supabase.key',
'services.supabase.service_key','session.driver','session.lifetime','session.expire_on_close','session.encrypt',
...
'api.rfid.verify','api.rfid-scan','api.rfid.scan-direct','api.rfid.latest-uid','api.rfid.generate-uid',
'api.rfid.scan.request','api.rfid.scan.status','api.rfid.recent-logs','api.rfid.test','api.rfid.test-deactivated',
'api.system-info','api.storage.fallback','generated::2RQXHaE2bw1teHoE','generated::8hIFwJI3XtRZ4gqG','login',
'login.post','register','register.post','explore','property.show',
'landlord.register','landlord.register.store','landlord.pending','landlord.rejected','super-admin.dashboard',
'super-admin.users','super-admin.pending-landlords','super-admin.approve-landlord','super-admin.reject-landlord','super-admin.landlord-docs',
'super-admin.verify-landlord-document','super-admin.create-user','super-admin.store-user','super-admin.edit-user','super-admin.update-user',
'super-admin.delete-user','super-admin.apartments','super-admin.settings','super-admin.settings.update','super-admin.settings.group.update',
'super-admin.check-dark-mode','landlord.dashboard','landlord.apartments','landlord.create-apartment','landlord.store-apartment',
'landlord.edit-apartment','landlord.update-apartment','landlord.delete-apartment','landlord.create-unit','landlord.create-unit-for-apartment',
'landlord.create-multiple-units','landlord.store-unit','landlord.store-bulk-units','landlord.bulk-edit-units','landlord.finalize-bulk-units',
'landlord.units','landlord.update-unit','landlord.delete-unit','landlord.tenant-assignments','landlord.store-tenant-assignment',
'landlord.assignment-details','landlord.update-assignment-status','landlord.reassign-tenant','landlord.delete-tenant-assignment','landlord.get-credentials',
'landlord.available-units','landlord.download-document','landlord.approve-application','landlord.reject-application','landlord.staff',
'landlord.add-staff','landlord.staff-by-type','landlord.create-staff','landlord.assign-staff','landlord.store-staff',
'landlord.staff-details','landlord.update-staff-status','landlord.delete-staff','landlord.get-staff-credentials','landlord.tenant-history',
'landlord.tenant-history.export-csv','landlord.security','landlord.security.create-card','landlord.security.store-card','landlord.security.card-details',
'landlord.security.toggle-card-status','landlord.security.reassign-card-form','landlord.security.reassign-card','landlord.security.access-logs','landlord.apartment-details',
'landlord.apartment-units','landlord.unit-details','landlord.store-apartment-unit-json','dashboard','tenant.dashboard',
'tenant.upload-documents','tenant.store-documents','tenant.download-document','tenant.delete-document','tenant.profile',
'tenant.lease','tenant.update-password','tenant.apply','staff.dashboard','staff.complete-assignment',
'staff.profile','staff.update-password','admin.units','admin.units.store','admin.units.filter',
'admin.units.stats','admin.units.types','landlord.tenants','generated::U5roEWyru4TivRYu','generated::2cryz6WK952md9rj',
'logout','storage.local',);
        registerArgumentsSet('views', 
'explore','landlord.apartments','landlord.assign-tenant','landlord.assignment-details','landlord.bulk-edit-units',
'landlord.create-apartment','landlord.create-multiple-units','landlord.create-unit','landlord.dashboard','landlord.edit-apartment',
'landlord.pending','landlord.register','landlord.security.access-logs','landlord.security.create','landlord.security.index',
'landlord.security.reassign','landlord.security.show','landlord.select-property-for-unit','landlord.staff','landlord.tenant-assignments',
'landlord.tenant-history','landlord.units','layouts.app','layouts.landlord-app','layouts.staff-app',
'layouts.super-admin-app','login','partials.property-cards','partials.tenant-sidebar','property-details',
'register','staff.dashboard','staff.no-assignment','staff.profile','super-admin.apartments',
'super-admin.create-user','super-admin.dashboard','super-admin.edit-user','super-admin.pending-landlords','super-admin.review-landlord-docs',
'super-admin.settings','super-admin.users','tenant-lease','tenant-profile','tenant.dashboard',
'tenant.explore','tenant.no-assignment','tenant.upload-documents','laravel-exceptions-renderer::components.card','laravel-exceptions-renderer::components.context',
...
'C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.failed','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.password','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.auth.throttle','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.previous','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.pagination.next',
'C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.reset','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.sent','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.throttled','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.token','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.passwords.user',
'C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.accepted_if','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.active_url','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.after_or_equal',
'C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_dash','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.alpha_num','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.any_of','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.array',
'C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ascii','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.before_or_equal','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.array','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.file',
'C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.numeric','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.between.string','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.boolean','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.can','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.confirmed',
'C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.contains','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.current_password','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_equals','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.date_format',
'C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.decimal','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.declined_if','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.different','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits',
'C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.digits_between','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.dimensions','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.distinct','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_end_with','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.doesnt_start_with',
'C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.email','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ends_with','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.enum','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.exists','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.extensions',
'C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.file','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.filled','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.array','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.file','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.numeric',
'C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gt.string','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.array','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.file','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.numeric','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.gte.string',
'C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.hex_color','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.image','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.in_array_keys',
'C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.integer','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ip','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv4','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ipv6','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.json',
'C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.list','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lowercase','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.array','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.file','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.numeric',
'C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lt.string','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.array','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.file','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.numeric','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.lte.string',
'C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mac_address','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.array','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.file','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.numeric','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max.string',
'C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.max_digits','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimes','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.mimetypes','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.array','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.file',
'C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.numeric','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min.string','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.min_digits','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_if',
'C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_unless','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.missing_with_all','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.multiple_of','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_in',
'C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.not_regex','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.numeric','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.letters','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.mixed','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.numbers',
'C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.symbols','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.password.uncompromised','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_if','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_unless',
'C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.present_with_all','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_accepted',
'C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_if_declined','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibited_unless','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.prohibits','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.regex','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required',
'C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_array_keys','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_accepted','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_if_declined','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_unless',
'C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_with_all','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.required_without_all','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.same',
'C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.array','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.file','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.numeric','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.size.string','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.starts_with',
'C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.string','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.timezone','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.unique','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uploaded','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uppercase',
'C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.url','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.ulid','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.uuid','C:.Users.MSI.Housync.vendor.laravel.framework.src.Illuminate.Translation.lang.en.validation.custom.attribute-name.rule-name',);
...
'FIREBASE_SYNC_ENABLED','FIREBASE_SYNC_IN_TESTS','FIREBASE_PROJECT_ID','FIREBASE_PRIVATE_KEY_ID','FIREBASE_PRIVATE_KEY',
'FIREBASE_CLIENT_EMAIL','FIREBASE_CLIENT_ID','FIREBASE_AUTH_URI','FIREBASE_TOKEN_URI','FIREBASE_AUTH_PROVIDER_X509_CERT_URL',
'FIREBASE_CLIENT_X509_CERT_URL','FIREBASE_DATABASE_URL','FIREBASE_STORAGE_BUCKET','FIREBASE_WEB_API_KEY','FIREBASE_AUTH_DOMAIN',
'FIREBASE_MESSAGING_SENDER_ID','FIREBASE_APP_ID','FIREBASE_RECAPTCHA_SITE_KEY','FIREBASE_RECAPTCHA_SECRET_KEY','FIREBASE_APP_CHECK_DEBUG_TOKEN',
'RFID_SERIAL_PORT','RFID_BAUD_RATE','RFID_DEVICE_ID','RFID_LOCATION','SUPABASE_URL',
